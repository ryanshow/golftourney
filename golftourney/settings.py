...
WSGI_APPLICATION = 'golftourney.wsgi.application'

# Database — uses DATABASE_URL in production (Railway provides this automatically),
...
# Media files (uploads)
# In production on Railway, point MEDIA_ROOT at your volume mount path (e.g. /data/media).
MEDIA_URL = '/media/'
...
# CSRF trusted origins — required when running behind Railway's proxy
